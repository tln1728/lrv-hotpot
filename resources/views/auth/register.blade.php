            ...
            <div class="p-4 md:p-5 pt-0 md:pt-0">
                <form id="registerForm" class="space-y-4" method="post" action="{{route('register')}}">
                    ...
                    <div>
                        ...
                        <input value="{{old('name')}}" type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"/>
                    </div>
