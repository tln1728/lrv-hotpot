<!-- Dropdown -->
<div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow" id="user-profile-dropdown">
    <div class="border-none flex-col" role="none">
        @auth
        <div class="text-center px-5 py-2.5">
            <span>
                {{Auth::user() -> name}}
            </span>
        </div>
